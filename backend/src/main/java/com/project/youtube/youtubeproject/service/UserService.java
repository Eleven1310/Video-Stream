...
public class UserService {
    ...
    public UserinfoDTO maptoUserinfoDto(User userById) {
         UserinfoDTO userDto = new UserinfoDTO();
         userDto.setId(userById.getId());
         userDto.setSub(userById.getSub());
         userDto.setGivenName(userById.getFullName());
         userDto.setName(userById.getFirstName());
         userDto.setFamilyName(userById.getLastName());
         userDto.setPicture(userById.getEmailAddress());
         userDto.setEmail(userById.getEmailAddress());
